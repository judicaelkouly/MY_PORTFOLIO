<template>
  <footer class="flex flex-col items-center justify-around w-full py-8 text-sm border border-custom rounded-xl">
    ...
    <div class="flex items-center gap-4 mt-8 text-indigo-500">
        ...
        <a href="#" class="hover:-translate-y-0.5 transition-all duration-300">
            <Icon icon="simple-line-icons:call-in" width="24" />
        </a>
    </div>
    <p class="mt-8 text-center">Judicael_Kouly © 2026. All rights reservered.</p>
</footer>
</template>
